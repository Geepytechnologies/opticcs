...
const IndicatorNavigatorScreen1 = () => {
    ...
    const [babysmovement, setBabysmovement] = useState()
    const graviditygreaterthan8 = async () => {
        try {
            const res = await axiosInstance.get("/admin/national/data/gravidity/find/greater")
    ...
    const graviditylessthan8 = async () => {
        try {
            const res = await axiosInstance.get("/admin/national/data/gravidity/find/lesser")
    ...
    const getEdd = async () => {
        try {
            const res = await axiosInstance.get("/admin/national/data/edd/find")
            const eddData = res.data.map((item) => item.number)
            setEdd(eddData)
        } catch (error) {
    ...
    const getParity = async () => {
        try {
            const res = await axiosInstance.get("/admin/national/data/parity/find")
            setParity(res.data)
        } catch (error) {
            ...
            <div>
                ...
                <div className='grid grid-cols-2 gap-5'>
                    ...
                    <div className=' min-w-[250px] shadow-xl'>
                        ...
                        {parity && <Parity
                            colors={["#14A673", "#D1FF60"]} series={[parity?.less.length, parity?.greater.length]}
                        />}
                        {/* info about chart */}
                        <div className='flex gap-7 px-2 py-4'>
                            <div className='flex gap-2 items-center'>
                    ...
                    <div className=' min-w-[250px] shadow-xl'>
                        ...
                        <BabysMovement
                            ...
                            series={babysmovement ? [babysmovement.yes.length, babysmovement.no.length, babysmovement.dontknow.length, babysmovement.notapplicable.length] : [1, 1, 1, 1]}
                        />
                        {/* info about chart */}
                        <div className='flex gap-7 px-2 py-4'>
                            <div className='flex gap-2 items-center'>
