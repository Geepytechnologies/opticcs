...
const IndicatorNavigatorScreen3 = ({ param }) => {
    ...
    const getIndicatordata = async () => {
        try {
            const res = await axiosInstance.get(`/admin/state/data/general/return?state=${state}`)
    ...
    const getIndicatordataforstate = async () => {
        try {
            const res = await axiosInstance.get(`/admin/state/data/general/return?state=${param.state}`)
            setDatainfo(res.data)
        } catch (error) {
    ...
    const getIndicatordataforlga = async () => {
        try {
            const res = await axiosInstance.get(`/admin/lga/data/general/return?lga=${param.lga}`)
            setDatainfo(res.data)
        } catch (error) {
    ...
    return (
        <>
            ...
            {param.query == "" && <p className="text-primary90 m-3 text-center font-[500] text-[14px]">Showing results for State...</p>}
            {param.query == "state" && <p className="text-primary90 m-3 text-center font-[500] text-[14px]">{`Showing results for ${state} state...`}</p>}
            {param.query == "lga" && <p className="text-primary90 m-3 text-center font-[500] text-[14px]">{`Showing results for ${param.lga} Local Government Area in ${state} state...`}</p>}
            {datainfo ? <>
                <motion.div initial={{
                    opacity: 0,
                }}
                    ...
                    <div>
                        ...
                        <div className='grid grid-cols-2 gap-5'>
                            ...
                            <div className=' min-w-[250px] shadow-xl'>
                                ...
                                <GenericPie
                                    colors={["#14A673", "#D1FF60"]} series={[datainfo.fever.yes, datainfo.fever.no]}
                                />
                                {/* info about chart */}
                            ...
                            <div className=' min-w-[250px] shadow-xl'>
                                ...
                                {/* The pie chart diagram */}
                                <GenericPie
                                    colors={["#14A673", "#D1FF60"]} series={[datainfo.headache.yes, datainfo.headache.no]}
                                />
                                {/* info about chart */}
                                <div className='flex gap-7 px-2 py-4'>
                                    <div className='flex gap-2 items-center'>
                    ...
                    <div>
                        ...
                        <div className='grid grid-cols-2 gap-5'>
                            ...
                            <div className=' min-w-[250px] shadow-xl'>
                                ...
                                <hr />
                                {/* The chart diagram */}
                                <GenericPie colors={["#14A673", "#D1FF60"]} series={[datainfo.difficultylyingflat.yes, datainfo.difficultylyingflat.no]} />
                                {/* info about chart */}
                                <div className='flex gap-7 px-2 py-4'>
                                    <div className='flex gap-2 items-center'>
                                        <div className='w-[7px] h-[7px] rounded-full bg-primary70'></div>
                            ...
                            <div className=' min-w-[250px] shadow-xl'>
                                ...
                                <hr />
                                {/* The chart diagram */}
                                <GenericPie colors={["#14A673", "#D1FF60"]} series={[datainfo.convulsionsduringpregnancy.yes, datainfo.convulsionsduringpregnancy.no]} />
                                {/* info about chart */}
                                <div className='flex gap-7 px-2 py-4'>
                                    <div className='flex gap-2 items-center'>
                                        <div className='w-[7px] h-[7px] rounded-full bg-primary70'></div>
                            ...
                            <div className=' min-w-[250px] shadow-xl'>
                                ...
                                <hr />
                                {/* The chart diagram */}
                                <GenericPie colors={["#14A673", "#D1FF60"]} series={[datainfo.abdominalpain.yes, datainfo.abdominalpain.no]} />
                                {/* info about chart */}
                                <div className='flex gap-7 px-2 py-4'>
                                    <div className='flex gap-2 items-center'>
                                        <div className='w-[7px] h-[7px] rounded-full bg-primary70'></div>
                            ...
                            <div className=' min-w-[250px] shadow-xl'>
                                ...
                                <hr />
                                {/* The chart diagram */}
                                <GenericPie colors={["#14A673", "#D1FF60"]} series={[datainfo.bloodinurine.yes, datainfo.bloodinurine.no]} />
                                {/* info about chart */}
                                <div className='flex gap-7 px-2 py-4'>
                                    <div className='flex gap-2 items-center'>
                                        <div className='w-[7px] h-[7px] rounded-full bg-primary70'></div>
