                ...
                <motion.div initial={{
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-6 mt-4">
                            ...
                            <button onClick={logout} className='text-white bg-[#7A6EFE] min-w-[100px] p-2 font-[500]'>Confirm</button>
                        </div>
                    ...
                    <div id="page" className="flex-[4] min-w-[1000px] bg-[#f8f9fa]">
                        ...
                        <div className="relative">
                            <div className="absolute z-50 top-0 left-0">
                                {showmenu ? <BsFillArrowLeftSquareFill onClick={() => setShowmenu(false)} className="text-[#7A6EFE] cursor-pointer text-[20px] " /> :
                                    <BsFillArrowRightSquareFill onClick={() => setShowmenu(true)} className="text-[#7A6EFE] cursor-pointer text-[20px]" />}
                            </div>
                            <Routes>
