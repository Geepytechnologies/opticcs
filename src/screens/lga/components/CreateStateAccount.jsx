...
const CreateStateAccount = () => {
    ...
    const [values, setValues] = useState({ ward: "", healthfacilityname: "", healthfacilityid: "", officeaddress: "", phone: "", email: "", userid: "", password: "" });
    ...
    const [healthfacilitynameError, sethealthfacilitynameError] = useState({ status: false, message: "" })
    ...
    const handleChange2 = (event) => {
        ...
        name == "healthfacilityname" && sethealthfacilitynameError({ status: false, message: "" })
    ...
    const validateValues = () => {
        ...
        if (values.healthfacilityname === "") {
            sethealthfacilitynameError({ status: true, message: "This field is required" });
            noErrors = false;
        }
                ...
                <form autoComplete='false' onSubmit={createAccount} className="mt-12">
                    <div className="grid grid-cols-2 md:grid-cols-2 gap-5 mb-4 mt-4">
                        <div className="flex flex-col">
                            ...
                            <input placeholder='Enter ward' type='text' name="ward" onChange={handleChange2} onBlur={handleStateBlur} className="p-[16px] myselect text-secondary30 bg-transparent outline-none rounded-[8px] border border-[#C6C7C8]" />

                        </div>
                        <div className="flex flex-col">
                            <div className='flex gap-3 items-center'>
                                <label className="text-[16px] font-[500] text-dark90">
                                    Health Facility Name<span className="ml-2 text-red-500">*</span>
                                </label>
                                {healthfacilitynameError.status && <span className='text-[12px] font-[500] italic text-red-500'>{healthfacilitynameError.message}</span>}
                            </div>
                            <input type='text' name="healthfacilityname" onBlur={handlehealthfacilitynameBlur} onChange={handleChange2}
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type='text' name="healthfacilityid" onBlur={handleStateidBlur} onChange={handleChange2}
                                className="p-[16px] text-secondary30 bg-transparent outline-none rounded-[8px] border border-[#C6C7C8]"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text" name="officeaddress" onChange={handleChange2} onBlur={handleOfficeBlur}
