...
const patientdetailreturn = ({ returnvisit }) => {
    ...
    const year = moment(returnvisit && returnvisit[0]?.returnvisit_date).format('YYYY');
    const month = moment(returnvisit && returnvisit[0]?.returnvisit_date).format('MM');
    const day = moment(returnvisit && returnvisit[0]?.returnvisit_date).format('DD');
    const time = moment(returnvisit && returnvisit[0]?.returnvisit_date).format('HH:mm:ss a');
        ...
        <>
            {returnvisit && returnvisit.length ? <div className='p-3'>
                <div className='flex gap-2 items-center justify-between px-2'>
                    ...
                    <div onClick={() => window.print()} className='flex gap-2 items-center justify-center'>
                        <AiOutlinePrinter />
