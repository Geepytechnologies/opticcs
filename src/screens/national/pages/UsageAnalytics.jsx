...
const UsageAnalytics = () => {
    ...
    const getStateSessiongraph = async () => {
        try {
            const res = await axiosInstance.get(`/session/data/state?state=${statesearch}`);
            setSessiongraphdata(res.data.result)
        } catch (err) {
    ...
    const getAllStateSession = async () => {
        try {
            const res = await axiosInstance.get(`/session/find/state?start_date=${formattedStartDate}&state=${statesearch}`);
            setSessions(res.data.result)
        } catch (err) {
