                ...
                <div className="relative p-5 flex flex-1 items-center justify-center ">
                    ...
                    <div className="h-full w-full z-[20] my-5 flex flex-col items-center justify-center">
                        <div className="p-2 flex flex-col items-center justify-center">
                            <p className='text-[56px] font-[600] text-center text-white'>Welcome to OptiCCS</p>
                            <div className="grid mt-8 grid-cols-1 md:grid-cols-2 gap-9">
                                <div className='bg-light10 rounded-[20px] py-[48px] flex flex-col items-center justify-center w-[350px] h-[200px]'>
                                    <div className='font-[600] text-[18px] text-primary90'>National OptiCCS</div>
                                    <div className='text-[#7A7C7F] text-center mb-[35px] mt-[12px] text-[12px] font-[400]'>Embark on a transformative healthcare journey with our comprehensive app</div>
                                    <Link to="/national" className='bg-primary90 text-white rounded-[8px] px-[10px] py-[16px]'>
                                        Login to platform
                                    </Link>
                                </div>
                                <div className='bg-light10 rounded-[20px] py-[48px] flex flex-col items-center justify-center w-[350px] h-[200px]'>
                                    <div className='font-[600] text-[18px] text-primary90'>State OptiCCS</div>
                                    <div className='text-[#7A7C7F] text-center mb-[35px] mt-[12px] text-[12px] font-[400]'>Embark on a transformative healthcare journey with our comprehensive app</div>
                                    <Link to="/state" className='bg-primary90 text-white rounded-[8px] px-[10px] py-[16px]'>
                                        Login to State
                                    </Link>
                                </div>
                                <div className='bg-light10 rounded-[20px] py-[48px] flex flex-col items-center justify-center w-[350px] h-[200px]'>
                                    <div className='font-[600] text-[18px] text-primary90'>LGA OptiCCS</div>
                                    <div className='text-[#7A7C7F] text-center mb-[35px] mt-[12px] text-[12px] font-[400]'>Embark on a transformative healthcare journey with our comprehensive app</div>
                                    <Link to="/lga" className='bg-primary90 text-white rounded-[8px] px-[10px] py-[16px]'>
                                        Login to LGA
                                    </Link>
                                </div>
                                <div className='bg-light10 rounded-[20px] py-[48px] flex flex-col items-center justify-center w-[350px] h-[200px]'>
                                    <div className='font-[600] text-[18px] text-primary90'>Health Facility OptiCCS</div>
                                    <div className='text-[#7A7C7F] text-center mb-[35px] mt-[12px] text-[12px] font-[400]'>Embark on a transformative healthcare journey with our comprehensive app</div>
                                    <Link to="/healthfacility" className='bg-primary90 text-white rounded-[8px] px-[10px] py-[16px]'>
